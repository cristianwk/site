<?PHP
	...
	$menu['phpMyAdmin'] = 'http://mysql.consultoriawk.com/login.php?phpMyAdmin=3dae3eeb39699b3ad6e5418c9c3653f7026caeb5';
	$menu['Sistemas']['ClickConsultorio']['HOMOLOGACAO'] = 'http://homologa.consultoriawk.com/';
	$menu['Sistemas']['Redimensionador'] = 'redimensionador';

	$menu['Sistemas']['PHPinfo'] = 'http://consultoriawk.com/phpinfo.php';
